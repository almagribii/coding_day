<?php
// --- LOGIKA PHP LOGIN (JANGAN DIHAPUS) ---
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    ...
                    <div>
                        <button class="btn-cta" data-bs-toggle="modal" data-bs-target="#loginModal">Mulai Coding</button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-code" id="loginModalLabel">> System Login_</h5>
                ...
                <div class="modal-body">
                    <form method="POST" action="index.php">
                        <div class="mb-3">
                            ...
                            <select class="form-select font-code" id="role" name="role">
                                <option value="PESERTA">Peserta (Challenger)</option>
                                <option value="PANITIA">Panitia (Admin)</option>
                                <option value="JURI">Juri (Judge)</option>
                            </select>
                        </div>
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-success fw-bold font-code">Connect to Dashboard</button>
                        </div>
                    </form>
                </div>
            </div>
